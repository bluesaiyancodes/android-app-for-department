...
public class syllabus_sem6 extends Fragment {
    private static final String SYLLABUS_SEM1="https://csdeptcbsh.000webhostapp.com/SemesterSyllabus/SixthSemester.pdf";
    private static final String GOOGLE_VIEW="http://drive.google.com/viewerng/viewer?embedded=true&url=";
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        getActivity().setTitle("Semester 6 - Syllabus");
